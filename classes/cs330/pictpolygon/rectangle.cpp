...
void Rectangle::put(ostream& os) const
{
...
void Rectangle::reflectHorizontally(double mirrorX)
{ 
  _topleft = _topleft.reflectHorizontally(mirrorX);
  _bottomright = _bottomright.reflectHorizontally(mirrorX);
  normalize();
}
...
void Rectangle::reflectVertically(double mirrorY)
{ 
  _topleft = _topleft.reflectVertically(mirrorY);
  _bottomright = _bottomright.reflectVertically(mirrorY);
  normalize();
}
