...
/**
 * C++ graphics class modeled after the Java java.awt.Graphics
 *
 * Important: this class uses device cooodinates - the origin 
 * defaults to the upper-left corner of the screen/page/whatever
 * with increasing x values moving you to rhe right and increasing
 * y values moving you down.
 *
 **/
