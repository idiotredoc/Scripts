...
void Circle::put(ostream& os) const
{  
...
void Circle::reflectHorizontally(double mirrorX)
{ 
  _center = _center.reflectHorizontally(mirrorX);
}


void Circle::reflectVertically(double mirrorY)
{ 
  _center = _center.reflectVertically(mirrorY);
}
